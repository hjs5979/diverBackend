# Generated by Django 4.2 on 2023-05-01 04:42
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('corr', '0004_answer_modify_date_question_modify_date'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='answer',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author_answer', to='corr.question'),
        ),
        migrations.AlterField(
            model_name='question',
            name='author',
